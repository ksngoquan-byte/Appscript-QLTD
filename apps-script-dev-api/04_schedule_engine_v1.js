...
function layNgayBatDauHieuLucV1_(task) {
  if (!choPhepDieuChinhLienKetTuTienNhiemV1_(task)) {
    return task.forecastStart || task.start || null;
  }
...
function layNgayKetThucHieuLucV1_(task) {
  if (!choPhepDieuChinhLienKetTuTienNhiemV1_(task)) {
    return task.forecastEnd || task.end || null;
  }

  return task.actualFinish || task.end || task.forecastEnd || null;
}

function choPhepDieuChinhLienKetTuTienNhiemV1_(task) {
  const raw = task && task.adjustLink;
  ...
  return normalized !== 'khong' && normalized !== 'no' && normalized !== 'false' && normalized !== '0';
}
...
function testScheduleEngineV1() {
  ...
  const case18 = chayTestMangScheduleEngineV1_([
    taoTaskTestScheduleV1_('1', 3, '', null, new Date(2026, 0, 20), new Date(2026, 0, 1), new Date(2026, 0, 3), 'Không'),
  ...
  const case19 = chayTestMangScheduleEngineV1_([
    taoTaskTestScheduleV1_('1', 3, '', null, new Date(2026, 0, 20), new Date(2026, 0, 1), new Date(2026, 0, 3), 'Có'),
    taoTaskTestScheduleV1_('2', 2, '1FS')
  ], anchor);
  ...
  const case20 = chayTestMangScheduleEngineV1_([
    taoTaskTestScheduleV1_('1', 3, '', new Date(2026, 0, 10), null, new Date(2026, 0, 1), new Date(2026, 0, 3), 'Không'),
  ...
  const case21 = chayTestMangScheduleEngineV1_([
    taoTaskTestScheduleV1_('1', 3, '', new Date(2026, 0, 10), null, new Date(2026, 0, 1), new Date(2026, 0, 3), 'Có'),
    taoTaskTestScheduleV1_('2', 2, '1SS')
  ], anchor);
  ...
  const case23 = chayTestMangScheduleEngineV1_([
    taoTaskTestScheduleV1_('1', 3, '', null, new Date(2026, 0, 20), new Date(2026, 0, 1), new Date(2026, 0, 3), ''),
    taoTaskTestScheduleV1_('2', 2, '1FS')
  ], anchor);
  assertScheduleV1_('Case 23 blank W behaves as Co', bangNgayV1_(case23['2'].start, new Date(2026, 0, 21)));

  const case24 = chayTestMangScheduleEngineV1_([
    taoTaskTestScheduleV1_('1', 3, '', null, new Date(2026, 0, 20), new Date(2026, 0, 1), new Date(2026, 0, 3), 'Không'),
    taoTaskTestScheduleV1_('2', 3, '', null, new Date(2026, 0, 15), new Date(2026, 0, 4), new Date(2026, 0, 6), 'Có'),
...
function taoTaskTestScheduleV1_(ref, duration, predecessorText, actualStart, actualFinish, forecastStart, forecastEnd, adjustLink) {
  return {
    rowIndex: 0,
    index: 0,
    ref: String(ref),
