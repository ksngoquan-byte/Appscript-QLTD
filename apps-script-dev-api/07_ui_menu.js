...
function taoMenuTongHopVaGanttQltdV1_() {
  ...
  ui.createMenu('📊 3. Tổng hợp & Gantt')
    ...
    .addSeparator()
    .addItem('🌐 Xem Gantt WebApp Viewer', 'showGanttWebAppViewer')
    .addItem('🧭 Xem DHTMLX Gantt Viewer', 'showDhtmlxGanttViewer')
    .addItem('🌍 Mở DHTMLX Gantt WebApp', 'openDhtmlxGanttWebAppTab')
    .addItem('⚙️ Cấu hình DHTMLX WebApp URL', 'setDhtmlxGanttWebAppUrl')
    .addItem('🧪 Kiểm tra map trạng thái DHTMLX', 'showDhtmlxGanttStatusMappingDiagnostic')
